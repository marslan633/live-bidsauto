...
return new class extends Migration
{
    ...
    {
        Schema::create('detailed_title_damage', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['detailed_title_id', 'damage_id', 'domain_id'], 'unique_detailed_title_damage_domain');
    ...
    {
        Schema::dropIfExists('detailed_title_damage');
    }
};