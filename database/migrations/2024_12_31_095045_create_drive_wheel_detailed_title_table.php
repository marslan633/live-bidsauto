...
return new class extends Migration
{
    ...
    {
        Schema::create('drive_wheel_detailed_title', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['drive_wheel_id', 'detailed_title_id', 'domain_id'], 'unique_drive_wheel_detailed_title_domain');
    ...
    {
        Schema::dropIfExists('drive_wheel_detailed_title');
    }
};