...
return new class extends Migration
{
    ...
    {
        Schema::create('drive_wheel_vehicle_model', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['drive_wheel_id', 'vehicle_model_id', 'domain_id'], 'unique_drive_wheel_vehicle_model_domain');
    ...
    {
        Schema::dropIfExists('drive_wheel_vehicle_model');
    }
};