...
return new class extends Migration
{
    ...
    {
        Schema::create('seller_type_vehicle_model', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['seller_type_id', 'vehicle_model_id', 'domain_id'], 'unique_seller_type_vehicle_model_domain');
    ...
    {
        Schema::dropIfExists('seller_type_vehicle_model');
    }
};