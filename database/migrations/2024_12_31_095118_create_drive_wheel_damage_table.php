...
return new class extends Migration
{
    ...
    {
        Schema::create('drive_wheel_damage', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['drive_wheel_id', 'damage_id', 'domain_id'], 'unique_drive_wheel_damage_domain');
    ...
    {
        Schema::dropIfExists('drive_wheel_damage');
    }
};