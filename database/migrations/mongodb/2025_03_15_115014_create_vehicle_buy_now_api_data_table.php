...
return new class extends Migration
{
    ...
    {
        Schema::connection('mongodb')->create('vehicle_buy_now_api_data', function (Blueprint $collection) {
        ...
        Schema::connection('mongodb')->table('vehicle_buy_now_api_data', function (Blueprint $collection) {
    ...
    {
        Schema::connection('mongodb')->dropIfExists('vehicle_buy_now_api_data');
    }
};
