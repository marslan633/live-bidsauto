...
return new class extends Migration
{
    ...
    {
        Schema::connection('mongodb')->create('vehicle_process_cached_api_data', function (Blueprint $collection) {
        ...
        Schema::connection('mongodb')->table('vehicle_process_cached_api_data', function (Blueprint $collection) {
    ...
    {
        Schema::connection('mongodb')->dropIfExists('vehicle_process_cached_api_data');
    }
};
