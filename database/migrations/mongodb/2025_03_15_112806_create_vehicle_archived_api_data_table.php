...
return new class extends Migration
{
    ...
    {
        Schema::connection('mongodb')->create('vehicle_archived_api_data', function (Blueprint $collection) {
        ...
        Schema::connection('mongodb')->table('vehicle_archived_api_data', function (Blueprint $collection) {
    ...
    {
        Schema::connection('mongodb')->dropIfExists('vehicle_archived_api_data');
    }
};
