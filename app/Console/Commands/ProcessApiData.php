...
class ProcessApiData extends Command
{
     ...
     */
     /**
     * Below Function Implementation with do while loop, execution on the base of next page.
     */
    ...
    // }
    /**
     * Below Function Implementation with total pages, execution on the base of page division.
     */
    // public function handle()
    // {
    //     $startTime = microtime(true);
    ...
    //     $minutes = 5; // Time frame in minutes
