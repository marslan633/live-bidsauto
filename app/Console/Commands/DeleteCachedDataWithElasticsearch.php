...
class DeleteCachedDataWithElasticsearch extends Command
{
     ...
     * @var string
     */
    protected $description = 'Delete records with status "completed" from Elasticsearch index "vehicle_api_data"';
    ...
    {
        $this->info('Starting to delete completed status records from vehicle_api_data...');
