        ...
        $config = [
            'manufacturers' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'manufacturer_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'vehicle_models' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'vehicle_model_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'vehicle_types' => [
                'relations' => [
            ...
            'conditions' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'condition_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'fuels' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'fuel_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'seller_types' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'seller_type_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'drive_wheels' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'drive_wheel_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'transmissions' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'transmission_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'detailed_titles' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'detailed_title_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'damages' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'damage_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'domains' => [
                'relations' => [
            ...
            'years' => [
                'relations' => [
                    ...
                    'buy_nows' => ['pivot' => 'year_buy_now', 'foreign_key' => 'buy_now_id'],
                ],
            ],
            'buy_nows' => [
                'relations' => [
                    'manufacturers' => ['pivot' => 'buy_now_manufacturer', 'foreign_key' => 'manufacturer_id'],
                    'vehicle_models' => ['pivot' => 'buy_now_vehicle_model', 'foreign_key' => 'vehicle_model_id'],
                    'vehicle_types' => ['pivot' => 'buy_now_vehicle_type', 'foreign_key' => 'vehicle_type_id'],
                    'conditions' => ['pivot' => 'buy_now_condition', 'foreign_key' => 'condition_id'],
                    'fuels' => ['pivot' => 'buy_now_fuel', 'foreign_key' => 'fuel_id'],
                    'seller_types' => ['pivot' => 'buy_now_seller_type', 'foreign_key' => 'seller_type_id'],
                    'drive_wheels' => ['pivot' => 'buy_now_drive_wheel', 'foreign_key' => 'drive_wheel_id'],
                    'transmissions' => ['pivot' => 'buy_now_transmission', 'foreign_key' => 'transmission_id'],
                    'detailed_titles' => ['pivot' => 'buy_now_detailed_title', 'foreign_key' => 'detailed_title_id'],
                    'damages' => ['pivot' => 'buy_now_damage', 'foreign_key' => 'damage_id', 'custom_field' => 'damage_main'],
                    'domains' => ['pivot' => 'buy_now_domain', 'foreign_key' => 'domain_id'],
                    'years' => ['pivot' => 'buy_now_year', 'foreign_key' => 'year_id'],
                ],
            ],
        ];
