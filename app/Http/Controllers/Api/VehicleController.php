        ...
        try {
            ...
            foreach ($filters as $key => $details) {
                ...
                if ($searchAttribute && in_array($searchAttribute, $validListings) && $searchValue) {
                    ...
                    $filteredResults = $cloneQuery->whereHas($filters[$searchAttribute]['relation'], function ($q) use ($searchValue) {
