...
public function filterAttributes(Request $request)
{
    ...
    */
    ...
    /**
     * Below Function to check the lenght of the data of third party api.
     */
    ...
    /**
     * Below Function store data manutually in Vehcile Archived Table
     */
    public function processArchievedData(Request $request) {
        $data = $request->all();
        ...
        // Return the result as JSON
       return sendResponse(true, 200, 'data added in archived table', $data, 200);
    }
    ...
    private function processCarData(array $car)
    {
        ...
        $vehicleRecord = VehicleRecordArchived::updateOrCreate(
            ['api_id' => $car['id']],
            [
                'year' => $car['year'],
                'year_id' => $year?->id,
    ...
    /**
     * End Function store data manutually in Vehcile Archived Table
     */
}