...
if (config('app.app_kvm_one') === true) {
    ...
    // });
    app(Schedule::class)->command('process:api-data')->dailyAt('19:20')->withoutOverlapping();
...
if (config('app.app_kvm_three') === true) {
    ...
    // app(Schedule::class)->command('index:vehicle-records')->dailyAt('12:15')->withoutOverlapping();
