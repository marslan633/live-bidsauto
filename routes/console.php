...
if (config('app.app_kvm_three') === true) {
    ...
    //app(Schedule::class)->command('process:exipre-and-status-sale-with-elasticsearch')->everyFifteenMinutes()->withoutOverlapping();

    //app(Schedule::class)->command('process:exipre-and-status-sale-with-elasticsearch')->everyFifteenMinutes()->withoutOverlapping();

   // app(Schedule::class)->command('process:active-and-status-not-sale-with-elasticsearch')->everyFifteenMinutes()->withoutOverlapping();
}
