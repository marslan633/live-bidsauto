...
if (config('app.app_kvm_one') === true) {
    ...
    app(Schedule::class)->command('index:vehicle-records-one')->dailyAt('07:28')->withoutOverlapping();
}
...
if (config('app.app_kvm_four') === true) {
    ...
    app(Schedule::class)->command('index:vehicle-records')->dailyAt('07:28')->withoutOverlapping();
